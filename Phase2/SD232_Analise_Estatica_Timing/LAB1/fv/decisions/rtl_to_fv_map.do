...
# Generated on: Tue Sep 01 20:09:03 -03 2026 (Tue Sep 01 23:09:03 UTC 2026)
...
set logfile fv/decisions/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/decisions -revised fv_map
...
read_library -liberty -both \
    /prj/ci/workarea/aluno3/ProjetosCarneiro/CI_Digital/Phase2/SD232_Analise \
    Estatica \
    de \
    Timing/LAB1/../LIB/slow_vdd1v0_basicCells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k RTL/decisions.v
elaborate_design -golden -root {decisions} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/decisions/fv_map.v.gz
elaborate_design -revised -root {decisions}
...
#add_name_alias fv/decisions/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.decisions.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.decisions.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.decisions.rtl.fv_map.rpt
