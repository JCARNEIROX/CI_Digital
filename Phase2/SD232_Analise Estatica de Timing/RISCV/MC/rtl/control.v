    ...
    begin
      case (opcode)
        ...
        7'b0000011: // LOAD TYPE
          begin
            regWE 	= 1'b1; // WRITE REGISTER
            rs1Sel 	= 1'b0; // SELECT REGISTER
            rs2Sel 	= 1'b1; // SELECT IMMEDIATE
            RegSel 	= 2'd0; // MEMORY
            PCSel 	= 2'd0;	
            AluOp 	= ADD;
            memWE 	= 1'b0;
            ...
            case (funct3)
              3'b000: //LB
                begin
                  memMode = 3'b000; // LOAD BYTE
                end
              3'b001: //LH
                begin
                  memMode = 3'b001; // LOAD 2 BYTES
                end
              3'b010: //LW
                begin
                  memMode = 3'b010; // LOAD 4 BYTES
                end
              3'b100: //LBU
                begin
                  memMode = 3'b100; // LOAD 1 BYTE UNSIGNED 
                end
              3'b101: //LHU
                begin
                  memMode = 3'b101; // LOAD 2 BYTES UNSIGNED
                end
              default:
                begin
                  memMode = 3'b010; // LOAD 4 BYTES
        ...
        7'b0100011: // store TYPE
          begin
            regWE 	= 1'b0; // DO NOT WRITE REGISTER
            rs1Sel 	= 1'b0; // SELECT REGISTER
            rs2Sel 	= 1'b1; // SELECT IMMEDIATE
            RegSel 	= 2'd0; // MEMORY
            PCSel 	= 2'd0;	
            ...
            case (funct3)
              3'b000: //SB
                begin
                  memMode = 3'b000; // STORE BYTE
                end
              3'b001: //SH
                begin
                  memMode = 3'b001; // STORE 2 BYTES
                end
              3'b010: //SW
                begin
                  memMode = 3'b010; // STORE 4 BYTES
                end
              default:
                begin
                  memMode = 3'b010; // LOAD 4 BYTES
