...
def main():
    ...
    if not modules_dirs:
        print("[ERRO] Nenhuma pasta 'modules' foi encontrada no projeto.")
        return
    ...
    for modules_dir in modules_dirs:
        ...
        for module_path in modules_dir.iterdir():
            ...
            # EX: iverilog -o Project1/modules/module1/resultados/sim.vvp -y Project1/modules/module2/rtl -y Project1/modules/module1/rtl Project1/modules/module1/rtl/*.v Project1/modules/module1/tb/*.v
            try:
                # compila de fato
